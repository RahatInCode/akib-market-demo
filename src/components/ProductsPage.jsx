...
const mockProducts = [
  // Available Products
  {
    ...
    features: ['Premium oak wood frame', 'High-density foam cushioning', 'Removable fabric cover', 'Weight capacity: 150kg'],
  },
  {
    id: 2,
    ...
    features: ['Premium velvet upholstery', 'Hardwood frame', 'Deep seating comfort', 'Available in 5 colors'],
  },
  {
    id: 3,
    ...
    features: ['Natural marble top', 'Gold-plated steel legs', 'Seats 6-8 people', 'Heat resistant'],
  },
  {
    id: 4,
    ...
    features: ['Solid walnut wood', '3 spacious drawers', 'Cable management', 'Scratch-resistant finish'],
  },
  {
    id: 5,
    ...
    features: ['Premium fabric upholstery', 'Solid wood frame', 'Extra tall headboard', 'Under-bed storage option'],
  },
  {
    id: 6,
    ...
    features: ['Metal frame', 'Reclaimed wood shelves', '5 spacious tiers', 'Easy assembly'],
  },
  ...
  // Pre-Order Products
  {
    ...
    description: 'Premium Italian leather L-shaped sectional sofa. Arriving February 2024.',
    features: ['100% Italian leather', 'Modular design', 'Built-in USB charging', 'Lifetime warranty'],
  },
  {
    id: 8,
    ...
    features: ['Solid teak wood', 'Includes 6 chairs', 'Expandable table', 'Vintage 1960s design'],
  },
  {
    id: 9,
    ...
    features: ['Low profile design', 'Japanese oak wood', 'Natural finish', 'Zen aesthetic'],
  },
  {
    id: 10,
    ...
    features: ['Hand-carved details', 'Velvet upholstery', 'Gold-leaf finish', 'Imported from France'],
  },
  {
    id: 11,
    ...
    features: ['Leather desk pad inlay', 'Built-in power outlets', 'File drawers', 'Cable management system'],
  },
  {
    id: 12,
    ...
    images: [
      'https://images.unsplash.com/photo-1551298370-9d3d53740c72?w=500&h=500&fit=crop',
    ],
    status: 'preorder',
    badge: 'PRE-ORDER',
    inStock: false,
    ...
    features: ['Hand-hammered brass', 'Tempered glass top', 'Intricate patterns', 'Artisan crafted'],
  },
];
...
// Product Card
const ProductCard = ({ product, onQuickView, onAddToWishlist }) => {
